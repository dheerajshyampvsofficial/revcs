	...
	public static void main(String[] args) {
		...
		class ArgsHandler {
			...
			private void buildCommands() {
				...
				commands.put("latest", "Get the latest snapshot name.");
			}
				...
				if(arguments.isEmpty())		
					...
					if(argument != null) {
						...
						if(argument.equals("--version"))
							...
							if(!mainFile.exists()) {
								System.err.println("error, main file in capsule or capsule itself is missing.");
								System.exit(-1);
							}
							
							MainObject mainObject = MainObject.deserialize(mainFile.getPath());
							
							System.out.println(mainObject.last_snapshot);
						}
